...
enum NetEvents
{
event_connect=1,//Alguém se conectou, reserve recursos para ele...
event_receive,//O peer enviou uma mensagem...
event_disconnect,//O peer se desconectou ou perdeu a conexão.
};
...
mutable std::shared_mutex mtx_input, mtx_output, mtx_con;
public:
basic_connection();
